...
class AnnotationMovePopup extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    const className = getClassName('Popup AnnotationMovePopup', this.props);
    ...
    return(
      <div className={className} data-element="annotationMovePopup" onClick={() => closeElement('annotationPopup')}>
        <StylePopup
...
const mapStateToProps = state => ({
  isDisabled: selectors.isElementDisabled(state, 'annotationMovePopup')
});
...
export default connect(mapStateToProps, mapDispatchToProps)(AnnotationMovePopup);
